      ...
      <Section>
        <Content full>
          <TextCard>
            ...
            , we have collected a number of resources here to quickly bring you
            up to speed. This content was produced primarily for a teaching case
            in our Michigan Sustainability Cases library, but because we believe
      ...
      <Section>
        <Content twothirds>
          <p>
            ...
            carcinogenic chemical, 1,4-dioxane. Since then, a chemical plume has
            continued to migrate through the city and county, contaminating
            local lakes and private drinking water wells. In the present, the
            state's consent decree that determines how the plume will be managed
            is showing signs that it may not adequately protect wildlife and
            citizens.
          </p>
          <p>
            This case study explores the question of whether the Ann Arbor city
            council should seek Superfund status for the Gelman site. To some,
            the federal, state and local response to the ecological and public
            health risks has been disappointing. Local advocacy has challenged
            authorities to resolve the issue. Some say designating the site as
            one of the nation’s worst (i.e., a Superfund site) could force a
            better cleanup, while others fear that labeling Ann Arbor as a toxic
