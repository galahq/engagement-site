    ...
    <Wrapper>
      ...
      <GridContainer>
        <Section>
          <Content full>
            <TextCard>
              With the dioxane plume and the decision of how best to pursue
              cleanup{' '}
              <a href="https://www.michiganradio.org/post/epa-involvement-many-years-ann-arbors-gelman-plume-cleanup">
                back in focus
              </a>
              , we have collected a number of resources here to quickly bring
              you up to speed. This content was produced primarily for a
              teaching case in our Michigan Sustainability Cases library, but
              because we believe strongly in connecting classroom learning with
              sustainability issues unfolding in real time, we are sharing these
              tools now as{' '}
          ...
          <Content>
            <HeaderVideoContainer>
              <VideoFrame
                src="https://player.vimeo.com/video/256510734"
                width="100%"
                height="100%"
        ...
        <Section>
          <Content twothirds>
            <p>
              ...
              severely contaminated an aquifer beneath the city with a
              carcinogenic chemical, 1,4-dioxane. Since then, a chemical plume
              has continued to migrate through the city and county,
              contaminating local lakes and private drinking water wells. In the
              present, the state's consent decree that determines how the plume
              will be managed is showing signs that it may not adequately
              protect wildlife and citizens.
            </p>
            <p>
              This case study explores the question of whether the Ann Arbor
              city council should seek Superfund status for the Gelman site. To
              some, the federal, state and local response to the ecological and
              public health risks has been disappointing. Local advocacy has
              challenged authorities to resolve the issue. Some say designating
              the site as one of the nation’s worst (i.e., a Superfund site)
              could force a better cleanup, while others fear that labeling Ann
              Arbor as a toxic site could bring negative consequences such as
...
and hosts Ed Waisanen and Anna Prushinskaya."
          ...
          <Content half>
            <p>
              The plume of dioxane-contaminated water spreading beneath Ann
              Arbor has been called a "slow-motion environmental disaster." In
              this podcast we follow the way in which public outreach and
              community participation have shaped this issue over the years,
              from its discovery in 1984 by Dan Bicknell (a University of
              Michigan student out for a swim) to the present-day debate over
            ...
            <p>
              ...
              for The Green Room on WEMU, reflects on the challenge of reporting
              on a dense legal and bureaucratic issue for a public that wants to
              know if its water is safe.
            </p>
            <p>
              Matthew Naud shares his perspective from a career of dealing with
              the plume as Environmental Coordinator for the City of Ann Arbor,
              where he has seen public concern with the plume wax and wane over
              the years.
            </p>
            <p>
              Detlef Knappe, a Professor at North Carolina State University,
              helps us untangle the mess of dioxane levels and what they mean
              for human health. He studies dioxane contamination in North
              Carolina, where surface water contamination has so far been easier
              to deal with.
            </p>
          </Content>
        </Section>
        ...
        <Section>
          <Content full>
            ...
            on the dioxane issue in the Ann Arbor area, bringing together
            experts, stakeholders, concerned citizens, and activists. Some
            attendees' thoughts, informed by years of working on the issue are
            featured here.
          </Content>
          <Content half>
            <VideoCard
              ...
              videoSrc="https://www.youtube.com/embed/WGGTjzM3aQY"
            ></VideoCard>
          </Content>
          <Content half>
            <VideoCard
              ...
              videoSrc="https://www.youtube.com/embed/Qj2G1fWfP5Q"
            ></VideoCard>
          </Content>
          <Content half>
            <VideoCard
              ...
              videoSrc="https://www.youtube.com/embed/GFzsNIL47kw"
            ></VideoCard>
          </Content>
          <Content half>
            <VideoCard
              ...
              videoSrc="https://www.youtube.com/embed/3lR3ug-CpxM"
            ></VideoCard>
          </Content>
        </Section>
        ...
        <Section>
          <Content full>
            Stakeholders and information repositories
            <List>
              <li>
